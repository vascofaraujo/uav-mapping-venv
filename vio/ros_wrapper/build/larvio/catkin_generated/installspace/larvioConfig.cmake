...
if("FALSE" STREQUAL "TRUE")
  set(larvio_SOURCE_PREFIX /home/renato/Documents/git-repo/LARVIO/ros_wrapper/src/larvio)
  set(larvio_DEVEL_PREFIX /home/renato/Documents/git-repo/LARVIO/ros_wrapper/devel)
  set(larvio_INSTALL_PREFIX "")
  set(larvio_PREFIX ${larvio_DEVEL_PREFIX})
else()
  set(larvio_SOURCE_PREFIX "")
  set(larvio_DEVEL_PREFIX "")
  set(larvio_INSTALL_PREFIX /home/renato/Documents/git-repo/LARVIO/ros_wrapper/install)
...
if(NOT "include;/usr/include;/usr/include/eigen3;/usr/local/include/opencv4;/usr/include/suitesparse " STREQUAL " ")
  set(larvio_INCLUDE_DIRS "")
  set(_include_dirs "include;/usr/include;/usr/include/eigen3;/usr/local/include/opencv4;/usr/include/suitesparse")
  if(NOT " " STREQUAL " ")
...
set(libraries "system_manager;estimator;image_processor;/usr/local/lib/libopencv_calib3d.so.4.5.3;/usr/local/lib/libopencv_core.so.4.5.3;/usr/local/lib/libopencv_dnn.so.4.5.3;/usr/local/lib/libopencv_features2d.so.4.5.3;/usr/local/lib/libopencv_flann.so.4.5.3;/usr/local/lib/libopencv_gapi.so.4.5.3;/usr/local/lib/libopencv_highgui.so.4.5.3;/usr/local/lib/libopencv_imgcodecs.so.4.5.3;/usr/local/lib/libopencv_imgproc.so.4.5.3;/usr/local/lib/libopencv_ml.so.4.5.3;/usr/local/lib/libopencv_objdetect.so.4.5.3;/usr/local/lib/libopencv_photo.so.4.5.3;/usr/local/lib/libopencv_stitching.so.4.5.3;/usr/local/lib/libopencv_video.so.4.5.3;/usr/local/lib/libopencv_videoio.so.4.5.3;/usr/local/lib/libopencv_aruco.so.4.5.3;/usr/local/lib/libopencv_barcode.so.4.5.3;/usr/local/lib/libopencv_bgsegm.so.4.5.3;/usr/local/lib/libopencv_bioinspired.so.4.5.3;/usr/local/lib/libopencv_ccalib.so.4.5.3;/usr/local/lib/libopencv_datasets.so.4.5.3;/usr/local/lib/libopencv_dnn_objdetect.so.4.5.3;/usr/local/lib/libopencv_dnn_superres.so.4.5.3;/usr/local/lib/libopencv_dpm.so.4.5.3;/usr/local/lib/libopencv_face.so.4.5.3;/usr/local/lib/libopencv_freetype.so.4.5.3;/usr/local/lib/libopencv_fuzzy.so.4.5.3;/usr/local/lib/libopencv_hfs.so.4.5.3;/usr/local/lib/libopencv_img_hash.so.4.5.3;/usr/local/lib/libopencv_intensity_transform.so.4.5.3;/usr/local/lib/libopencv_line_descriptor.so.4.5.3;/usr/local/lib/libopencv_mcc.so.4.5.3;/usr/local/lib/libopencv_optflow.so.4.5.3;/usr/local/lib/libopencv_phase_unwrapping.so.4.5.3;/usr/local/lib/libopencv_plot.so.4.5.3;/usr/local/lib/libopencv_quality.so.4.5.3;/usr/local/lib/libopencv_rapid.so.4.5.3;/usr/local/lib/libopencv_reg.so.4.5.3;/usr/local/lib/libopencv_rgbd.so.4.5.3;/usr/local/lib/libopencv_saliency.so.4.5.3;/usr/local/lib/libopencv_shape.so.4.5.3;/usr/local/lib/libopencv_stereo.so.4.5.3;/usr/local/lib/libopencv_structured_light.so.4.5.3;/usr/local/lib/libopencv_superres.so.4.5.3;/usr/local/lib/libopencv_surface_matching.so.4.5.3;/usr/local/lib/libopencv_text.so.4.5.3;/usr/local/lib/libopencv_tracking.so.4.5.3;/usr/local/lib/libopencv_videostab.so.4.5.3;/usr/local/lib/libopencv_wechat_qrcode.so.4.5.3;/usr/local/lib/libopencv_xfeatures2d.so.4.5.3;/usr/local/lib/libopencv_ximgproc.so.4.5.3;/usr/local/lib/libopencv_xobjdetect.so.4.5.3;/usr/local/lib/libopencv_xphoto.so.4.5.3;/usr/lib/x86_64-linux-gnu/libspqr.so;/usr/lib/x86_64-linux-gnu/libcholmod.so;/usr/lib/x86_64-linux-gnu/libccolamd.so;/usr/lib/x86_64-linux-gnu/libcamd.so;/usr/lib/x86_64-linux-gnu/libcolamd.so;/usr/lib/x86_64-linux-gnu/libamd.so;/usr/lib/x86_64-linux-gnu/liblapack.so;/usr/lib/x86_64-linux-gnu/libf77blas.so;/usr/lib/x86_64-linux-gnu/libatlas.so;/usr/lib/x86_64-linux-gnu/libsuitesparseconfig.so;/usr/lib/x86_64-linux-gnu/librt.so")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/renato/Documents/git-repo/LARVIO/ros_wrapper/install/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(larvio_EXPORTED_TARGETS ${${larvio_dep}_EXPORTED_TARGETS})
endforeach()
